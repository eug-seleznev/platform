...
import { ALL_USERS,CHANGE_CURSOR_STATUS,DELETE_CONTRACTOR,CHANGE_TASKS_STATUS,CHANGE_CONTAINER,SORT_USER_TASKS,MY_TASK_DELITE, EDIT_USER_TASK, FINISH_USER_TASK,ADD_USER_TASK,FIND_CONTRACTOR, SEARCH_TABLE_USER,EDIT_CONTRACTOR, CHANGE_PERMISSION, PERM_RETURN,ONE_CONTRACTOR, ONE_USER,SEARCH_USER,BACK_WHITE,ADD_CONTRACTOR,ALL_CONTRACTORS, ERROR_MSG, GREEN_MSG,PARTITION_UPDATE, EDIT_TASK} from "../types";
...
export const tasksStatus = (status) => async dispatch =>{
  dispatch({
...
export const cursorStatus = (status) => async dispatch =>{
  dispatch({
    type: CHANGE_CURSOR_STATUS,
    payload: status
})
