      ...
      <div>
        ...
        >
            ...
            {tasks!==undefined?
              ...
              <Light >{completeTasks}/{allTasks}</Light>
                <div className={style.card__thing}>
                  <div style={{width:`${Math.trunc((completeTasks/allTasks)*100)}%`}} className={style.card__thing__full}></div>
                </div>
              </div>:''}
        ...
        <form onSubmit={onEditSubmit}>
          {!isSubmit ? (
            ...
            <Thin style={{marginBottom: '20px',marginTop: '20px', cursor:'pointer'}} onClick={() => setSubmit(false)}>
              {sprint_description !== ""
